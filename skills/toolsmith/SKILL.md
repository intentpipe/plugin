...
1. Confirm the repetition is real: find the ≥3 places (task notes, transcripts, code) where agents did this by hand. If you can't, say so and stop.
...
4. Record it in ONE line in your agent memory (`MEMORY.md`), never in a CLAUDE.md.
